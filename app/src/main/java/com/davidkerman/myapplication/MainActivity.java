...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializePhonecall() {
        ...
        if (phone != null && Pattern.matches("^\\+?[0-9]{10,15}$", phone)){
            ...
            Toast.makeText(MainActivity.this, "Please enter a phone number or check that you have a correct phone number format", Toast.LENGTH_SHORT).show();
    }
    ...
    private void showPermissionRationableDialog() {
        new MaterialAlertDialogBuilder(this)
                ...
                .setNegativeButton("Cancel", (dialog, which) -> Toast.makeText(MainActivity.this, "Permission denied", Toast.LENGTH_SHORT).show())
                .show();
    }
}